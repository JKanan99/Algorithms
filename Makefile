...
algorithms_test: algorithms.hpp algorithms.cpp algorithms_test.cpp
	clang++ ${CLANG_FLAGS} ${GTEST_FLAGS} algorithms.cpp algorithms_test.cpp -o algorithms_test

algorithms_timing: timer.hpp algorithms.hpp algorithms.cpp algorithms_timing.cpp
	clang++ ${CLANG_FLAGS} algorithms.cpp algorithms_timing.cpp -o algorithms_timing
